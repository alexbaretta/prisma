...
import { defineConfig, env } from "@prisma-lossless/cli/config";
...
// npm install --save-dev prisma-lossless dotenv
...
export class Init implements Command {
  ...
  2. Run ${green(getCommandWithExecutor('prisma-lossless db pull'))} to introspect your database.`
...
CREATE NEW DATABASE:
  Local: ${green('npx prisma-lossless dev')} (runs Postgres locally in your terminal)
