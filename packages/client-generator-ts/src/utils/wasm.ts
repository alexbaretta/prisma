...
export function buildGetWasmModule({
  ...
  // importing them from the `@prisma-lossless/client` package. We can then rely on the
  ...
  // `@prisma-lossless/client/runtime` when doing it manually with `fs.readFile`. The
