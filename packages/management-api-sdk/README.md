...
A TypeScript SDK for the Prisma Developer Platform Management API. Use the simple client for direct API access, or the full SDK with built-in OAuth authentication and automatic token refresh.
...
```bash
npm install @prisma-lossless/management-api-sdk
```

## Basic Usage

For usage with an existing access or [service token](https://www.prisma.io/docs/postgres/introduction/management-api#service-tokens).
...
```typescript
import { createManagementApiClient } from '@prisma-lossless/management-api-sdk'
...
For applications that need [OAuth authentication](https://www.prisma.io/docs/postgres/introduction/management-api#oauth-20-authentication), automatic token refresh, and token storage management, use the full SDK.
...
```typescript
import { createManagementApiSdk, type TokenStorage } from '@prisma-lossless/management-api-sdk'
...
```typescript
import { AuthError } from '@prisma-lossless/management-api-sdk'
...
```typescript
import { FetchError } from '@prisma-lossless/management-api-sdk'
...
```typescript
import type { paths, components } from '@prisma-lossless/management-api-sdk'
