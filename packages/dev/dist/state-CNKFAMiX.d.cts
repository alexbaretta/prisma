...
interface ExperimentalQueryInsightsMetadata {
    readonly serverUrl: string;
    readonly sqlitePath: string;
    readonly streamName: string;
    readonly url: string;
...
interface ExperimentalServerMetadata {
    readonly queryInsights?: ExperimentalQueryInsightsMetadata;
...
declare const serverDumpV1Schema: valibot.ObjectSchema<{
    ...
    readonly experimental: valibot.OptionalSchema<valibot.ObjectSchema<{
        readonly queryInsights: valibot.OptionalSchema<valibot.ObjectSchema<{
...
interface ServerOptions {
     ...
     * `@electric-sql/pglite-socket` server used by `@prisma-lossless/dev`.
    ...
    /**
     * The port the streams server will listen on.
     *
     * Defaults to `51216`.
     *
     * An error is thrown if the port is already in use.
...
export { type ExperimentalQueryInsightsMetadata as E, type PersistenceMode as P, type ResolvedServerOptions as R, type ServerOptions as S, type ExperimentalStreams as a, type Exports as b, ServerAlreadyRunningError as c, ServerState as d, type ScanOptions as e, type ServerDumpV1 as f, ServerStateAlreadyExistsError as g, type ServerStatusV1 as h, deleteServer as i, getServerStatus as j, isServerRunning as k, killServer as l };
